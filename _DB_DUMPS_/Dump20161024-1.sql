CREATE DATABASE  IF NOT EXISTS `sys_pos_rejekiutama` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `sys_pos_rejekiutama`;
...
INSERT INTO `credit` VALUES (1,'SLO001-1',NULL,'2016-09-05',2,0),(2,'SLO001-8',NULL,'2016-10-01',400,1),(3,'SLO001-9',NULL,'2016-10-01',400,1),(4,'SLO001-10',NULL,'2016-10-17',200,1);
...
INSERT INTO `daily_journal` VALUES (1,1,'2016-09-03 00:15:00',2,NULL,'PEMBAYARAN SLO001-1',1,1),(2,1,'2016-10-01 00:42:00',400,NULL,'PEMBAYARAN SLO001-8',1,1),(3,1,'2016-10-01 14:28:00',400,NULL,'PEMBAYARAN SLO001-9',1,1),(4,1,'2016-10-17 15:11:00',200,NULL,'PEMBAYARAN SLO001-10',1,1);
...
INSERT INTO `debt` VALUES (1,'PO-1','2016-09-23',220,0);
/*!40000 ALTER TABLE `debt` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `detail_reminder`
--

DROP TABLE IF EXISTS `detail_reminder`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `detail_reminder` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `REMINDER_ID` int(11) DEFAULT NULL,
  `SCHEDULED_DATE` datetime DEFAULT NULL,
  `REMINDER_FLAG` tinyint(4) DEFAULT '1',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `detail_reminder`
--

LOCK TABLES `detail_reminder` WRITE;
/*!40000 ALTER TABLE `detail_reminder` DISABLE KEYS */;
INSERT INTO `detail_reminder` VALUES (1,1,'2016-10-24 00:00:00',1),(2,2,'2016-10-24 00:00:00',1),(3,3,'2016-10-23 00:00:00',1),(4,4,'2016-10-25 00:00:00',1),(5,5,'2016-10-31 00:00:00',1),(6,6,'2016-10-27 00:00:00',1),(7,7,'2016-11-14 00:00:00',1);
/*!40000 ALTER TABLE `detail_reminder` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `master_customer` VALUES (1,'PELANGGAN 1','JALAN JALAN','JALAN SATU','KOTA KOTA','12345',' ',' ',1,'2016-09-29',0,1,0,1,0,NULL),(2,'123','123','123','123','123','123','13',1,'2016-10-20',123,1,123,0,0,'1982-10-20');
...
INSERT INTO `master_message` VALUES (1,0,37,'SLO001-1','2016-09-17 00:00:00','SALES INVOICE [SLO001-1] JATUH TEMPO TGL 05-September-2016',NULL,NULL),(2,0,31,'PO-1','2016-10-15 00:00:00','PURCHASE ORDER [PO-1] JATUH TEMPO TGL 23-September-2016',NULL,NULL);
...
INSERT INTO `master_product` VALUES (1,'1','0','ANOTHER PRODUCT','AAAA',10,1,1,1,' ',1,11,0,'--00',1,' ',0);
...
INSERT INTO `master_reminder` VALUES (1,1,1,'2016-10-24',1,0,'00:00:00','aaaaa',1),(2,2,1,'2016-10-24',1,1,'00:00:00','aaaaabbbb',1),(3,3,1,'2016-10-23',1,1,'00:00:00','aaaaabbbb',1),(4,4,1,'2016-10-24',1,0,'00:00:00','aaaaa',1),(5,5,1,'2016-10-24',1,1,'00:00:00','aaaaa',1),(6,6,1,'2016-10-24',3,0,'00:00:00','aaaaa',1),(7,7,1,'2016-10-24',3,1,'00:00:00','aaaaa',1);
...
INSERT INTO `master_supplier` VALUES (1,'SUPPLIER 1','AAA','11',' ',' ',' ',' ',1);
...
INSERT INTO `master_technician` VALUES (1,'ANDRI','ANDRI',1);
...
INSERT INTO `master_unit` VALUES (1,'UNIT 1','111',1);
...
INSERT INTO `product_location` VALUES (1,1,'',0),(2,2,'',0),(3,1,'1',8),(4,2,'1',3);
...
INSERT INTO `products_received_detail` VALUES (1,'PR-1','1',10,22,22,220,0);
...
INSERT INTO `products_received_header` VALUES (1,'PR-1',1,0,'2016-09-03',220,NULL,'PO-1');
...
INSERT INTO `purchase_detail` VALUES (1,'PO-1','1',10,22,220);
...
INSERT INTO `purchase_header` VALUES (1,'PO-1',1,'2016-09-02',220,1,20,'2016-09-03','2016-09-23',0,1,1);
...
INSERT INTO `sales_detail` VALUES (1,'SLO001-1',0,'1',10,1,2,0,0,0,2),(2,'SLO001-2',0,'1',10,1,2,0,0,0,2),(3,'SLO001-3',0,'1',10,1,2,0,0,0,0),(4,'SLO001-4',0,'1',10,1,2,0,0,0,2),(5,'SLO001-5',0,'1',10,1,2,0,0,0,0),(6,'SLO001-6',0,'1',10,1,2,0,0,0,0),(7,'SLO001-7',0,'1',10,1,2,0,0,0,0),(8,'SLO001-8',0,'1',10,200,2,0,0,0,400),(9,'SLO001-9',0,'1',0,200,2,0,0,0,400),(10,'SLO001-10',0,'1',0,100,2,0,0,0,200);
...
INSERT INTO `sales_header` VALUES (1,'SLO001-1',0,0,'2016-09-03 00:15:00',2,0,0,0,'2016-09-05',0,0,0,0,NULL,0,1,0),(2,'SLO001-2',0,0,'2016-09-27 15:26:00',2,0,0,1,'2016-09-27',1,2,0,0,NULL,0,1,1),(4,'SLO001-3',0,1,'2016-09-30 00:19:00',0,0,0,1,'2016-09-30',1,0,0,0,NULL,0,1,0),(5,'SLO001-4',0,1,'2016-09-30 00:30:00',2,0,0,1,'2016-09-30',1,0,0,0,NULL,0,0,0),(6,'SLO001-5',0,1,'2016-09-30 00:33:00',0,0,0,1,'2016-09-30',1,0,0,0,NULL,0,1,0),(7,'SLO001-6',0,1,'2016-09-30 00:34:00',0,0,0,1,'2016-09-30',1,0,0,0,NULL,0,1,0),(8,'SLO001-7',0,1,'2016-09-30 00:49:00',0,0,0,1,'2016-09-30',1,0,0,0,NULL,0,1,0),(9,'SLO001-8',0,1,'2016-10-01 00:42:00',400,0,0,1,'2016-10-01',1,1000,600,0,NULL,0,0,0),(10,'SLO001-9',0,0,'2016-10-01 14:28:00',400,0,0,1,'2016-10-01',1,400,0,0,NULL,0,1,0),(11,'SLO001-10',0,1,'2016-10-17 15:11:00',200,10,20,1,'2016-10-17',1,200,20,0,NULL,0,0,0);
...
INSERT INTO `surat_tugas_detail` VALUES (8,'SLO001-8','1',2),(10,'SLO001-9','1',2),(11,'SLO001-7','1',2),(12,'SLO001-6','1',2),(13,'SLO001-10','1',2);
...
INSERT INTO `surat_tugas_header` VALUES (9,'SLO001-8',1,'2016-10-01 01:06:00',1,'2016-10-01',NULL,'2016-10-06','10:00:00',0),(10,'SLO001-9',0,'2016-10-01 22:20:00',1,'2016-10-01','10:00:00','2016-10-01','20:00:00',1),(11,'SLO001-7',1,'2016-10-07 12:47:00',1,'2016-10-07','10:00:00','2016-10-07','00:00:00',0),(12,'SLO001-6',1,'2016-10-07 12:51:00',1,'2016-10-07','20:00:00','2016-10-07','00:00:00',0),(13,'SLO001-10',1,'2016-10-17 15:18:00',0,'2016-10-19','10:00:00','2016-10-17','00:00:00',0);
...
INSERT INTO `sys_config` VALUES (1,'SLO001',0,0,'127.0.0.1',NULL,NULL,NULL,NULL),(2,'',0,1,'127.0.0.1','AA','AA','11','aa');
...
-- Dump completed on 2016-10-24 23:34:24
