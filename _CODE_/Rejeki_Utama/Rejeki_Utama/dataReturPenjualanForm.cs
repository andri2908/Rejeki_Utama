...
namespace AlphaSoft
{
    public partial class dataReturPenjualanForm : Form
    {
        ...
        private double invoiceTotalValue = 0;
        ...
        private bool dataValidated()
        {
            ...
            if (globalTotalValue > invoiceTotalValue)
            {
                errorLabel.Text = "NILAI RETUR MELEBIHI NILAI INVOICE";
                gutil.saveSystemDebugLog(globalConstants.MENU_RETUR_PENJUALAN, "dataValidated [NILAI RETUR > NILAI INVOICE]");
                return false;
            }
